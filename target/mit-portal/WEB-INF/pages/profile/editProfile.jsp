...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${contextPath}/resources/css/editProfile.css?v=${softwareVersion}">
    ...
    <body>
        ...
        <div id="container" class="container mainContainer pageContent">
            ...
            <jsp:include page="../common/menu.jsp">
                <jsp:param name="activeItem" value="menuEditProfile"></jsp:param>
            </jsp:include>
            <!-- MENU END -->
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xs-9 editProfileContainer">
                    <jsp:include page="editProfileContent.jsp"></jsp:include>
                </div>
            </div>
